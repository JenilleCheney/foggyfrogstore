        ...
        <div className="position-fixed bottom-0 end-0 p-4" style={{ zIndex: 9999 }}>
            ...
            {open && (
                ...
                >
                    ...
                    <div className="card-header d-flex align-items-center gap-2 py-2"
                         style={{ backgroundColor: "#4a7c59", borderBottom: "none" }}>
            <span
                className="rounded-circle"
                style={{ width: 8, height: 8, display: "inline-block", backgroundColor: "#a0d911" }}
            />
                        <div className="flex-grow-1">
                            <div className="fw-medium text-white" style={{ fontSize: 13 }}>Foggy Frog Exotics Assistant</div>
                            <div style={{ fontSize: 11, color: "#d4e8d0" }}>Online</div>
                        </div>
                        <button
                    ...
                    >
                        {messages.map((msg, i) => (
                            ...
                            >
                                <div
                                    className={`px-2 py-2 rounded ${msg.role === "user" ? "text-white" : "text-dark"}`}
                                    style={{
                                        maxWidth: "82%",
                                        fontSize: 13,
                                        lineHeight: 1.5,
                                        backgroundColor: msg.role === "user" ? "#4a7c59" : "#eef4e8",
                        ...
                        {loading && (
                            <div className="d-flex justify-content-start">
                                <div className="px-3 py-2 rounded d-flex gap-1 align-items-center"
                    ...
                    <div className="card-footer d-flex gap-2 p-2">
                        ...
                        <button
                            ...
                            style={{ width: 32, height: 32, padding: 0, backgroundColor: "#4a7c59", color: "#fff" }}
                        >
            ...
            <div className="d-flex justify-content-end">
                <button
                    ...
                    onClick={() => setOpen(o => !o)}
                    style={{ width: 48, height: 48, padding: 0, backgroundColor: "#4a7c59", color: "#fff" }}
                >
